...
import com.fh.core.utils.DateUtils;
import com.fh.core.utils.FileUtil;
import com.fh.core.utils.HttpClientUtils;
...
public class ProductServiceImpl extends BaseBiz implements IProductService {
	...
	public List<ProductVO> findProductList() {
		...
		for (Product product : productList) {
			...
			productVO.setProductPrice(Float.valueOf(product.getProductPrice()));
